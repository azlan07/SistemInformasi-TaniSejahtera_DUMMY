            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Entry Data Peminjaman Potong Rumput Kel-Tani Sejahtera</h4>
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <form action="/potong_rumput" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="kode_potong_rumput" class="form-label">Kode Potong Rumput</label>
                                        <input type="text"
                                            class="form-control @error('kode_potong_rumput') is-invalid @enderror"
                                            id="kode_potong_rumput" name="kode_potong_rumput" value="{{ old('kode_potong_rumput') }}">
