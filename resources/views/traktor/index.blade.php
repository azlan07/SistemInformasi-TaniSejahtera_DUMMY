            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                @foreach ($traktors as $iuran)
                                    <tr>
                                        ...
                                        <td class="d-grid gap-2 d-md-flex justify-content">
                                            <a href="/traktor/{{ $iuran->id }}/edit" class="btn btn-warning">Edit</a>
                                            <form class="d-inline" action="/traktor/{{ $iuran->id }}" method="post">
                                                @method('DELETE')
                                                @csrf
                        ...
                        <a href="/printTraktor" target="_blank" class="btn btn-primary">Print</a>
                    </div>
                </div>
            </div>
        </div>
