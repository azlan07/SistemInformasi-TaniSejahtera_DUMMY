            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Data Kel-Tani Sejahtera</h4>
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <form action="/jadwal_garap/{{ $jadwal_garaps->id }}" method="post">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_anggota">
                                            @foreach ($anggotas as $anggota)
                                                @if (old('id_anggota', $jadwal_garaps->id_anggota) == $anggota->id)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="sawah_id">
                                            @foreach ($sawahs as $sawah)
                                                @if (old('sawah_id', $jadwal_garaps->sawah_id) == $sawah->id)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            class="form-control @error('tanggal_garap') is-invalid @enderror"
                                            id="tanggal_garap" name="tanggal_garap"
                                            value="{{ old('tanggal_garap', $jadwal_garaps->tanggal_garap) }}">
                                        @error('tanggal_garap')
